...
#define ORDER_FILENAME "./txt/order.txt"
#ifndef USER_FILENAME
...
#define COMMAND_DELETE_FROM_CART "DELETE_FROM_CART" // MEMBER(2.2.4)
...
// ADDED
#define MAX_CART_PER_USER 10
#define MAX_USERS 512
#define MAX_CART (MAX_USERS * MAX_CART_PER_USER)
